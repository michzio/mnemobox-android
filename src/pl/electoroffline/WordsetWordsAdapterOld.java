 ...
 *
 */
public class WordsetWordsAdapterOld extends BaseExpandableListAdapter implements WordsetWordsAccessorOld.Callbacks, OnCheckedChangeListener {
	...
	private WordsetWordsAccessorOld wordsAccessor;
	 ...
	 * @param wordsetId
	 */
	public WordsetWordsAdapterOld(Activity a, int wordsetId) {
		activity = a; 
		...
		wordsAccessor = new WordsetWordsAccessorOld(activity, wordsetId, false);
     ...
     */
	@Override
    public void onWordsLoadFinished(WordsetWordsAccessorOld wordsAccessor) {
      	
      		Log.w(WordsetWordsAccessorOld.Callbacks.class.getName(), 
      					"Words loading finished! (" + wordsAccessor.getWordIds().size() + ")");
      		
      		for(String word : wordsAccessor.getForeignWords().values())
      			Log.w(WordsetWordsAccessorOld.Callbacks.class.getName(), "Loaded word: " + word); 
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		wordCheckBox.setText(foreignWords.get(groupWordId) + " - " + nativeWords.get(groupWordId));
	...
	public void onCheckedChanged(CompoundButton view, boolean isChecked) {
		...
		Log.w(WordsetActivityOld.class.getName(), "Change in checked state of word with id: " + String.valueOf( clickedWordId ));
