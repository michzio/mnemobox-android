...
public class SeekBarPreference extends Preference implements OnSeekBarChangeListener {
	...
	private static final String APPLICATIONNS="http://schemas.android.com/apk/res/pl.electoroffline";
	...
	private void initPreference(Context context, AttributeSet attrs) {
		...
		initValuesDynamically(); 
		if(DrawerActivity.isRTL()) { 
			mSeekBar = new ReversedSeekBar(context, attrs); 
		} else { 
	...
	protected void initValuesDynamically() { 
		/**
		 * Here you initialize default values of SeekBarPreference 
		 * dynamically (programmatically) ex. based on system settings 
		 * Can be overridden by custom SeekBarPreference that inherits from this class. 
		 */
	}
	...
	protected void updateView(View view) {
		...
		try {
			...
			TextView minValueLabel = (TextView)view.findViewById(R.id.seekBarPrefMinValue); 
			minValueLabel.setText(String.valueOf(mMinValue)); 
			
			TextView maxValueLabel = (TextView)view.findViewById(R.id.seekBarPrefMaxValue); 
			maxValueLabel.setText(String.valueOf(mMaxValue)); 
