...
public class GraphViewSeries {
	...
	public void appendData(GraphViewData value, boolean scrollToEnd) {
		GraphViewData[] newValues = resizeArray(values, values.length+1);
        ...
        private static GraphViewData[] resizeArray (GraphViewData[] oldArray, int newSize) {
            int oldSize = java.lang.reflect.Array.getLength(oldArray);
            
            GraphViewData[] newArray = new GraphViewData[newSize];
